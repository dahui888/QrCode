...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        flashlight1 = (CheckBox) view.findViewById(R.id.flashlight1);

        surfaceHolder = surfaceView.getHolder();
        //开关
       flashlight1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
           @Override
           public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               if (isChecked){
                   CodeUtils.isLightEnable(true);
                   flashlight1.setBackground(getResources().getDrawable(R.drawable.flashlight_open));
               }else {
                   CodeUtils.isLightEnable(false);
                   flashlight1.setBackground(getResources().getDrawable(R.drawable.flashlight_close));
               }
           }
       });
